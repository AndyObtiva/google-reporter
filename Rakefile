...
Juwelier::Tasks.new do |gem|
  ...
  gem.homepage = "http://github.com/ariel-codes/google_reporter"
  gem.license = "MIT"
  gem.summary = %Q{Google Reporter}
  gem.description = %Q{Google Reporter}
  gem.email = "ariel.santos@dcc.ufmg.br"
  gem.authors = ["Ariel Santos"]
...
Rake::RDocTask.new do |rdoc|
  ...
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title = "google_reporter #{version}"
